...
function displayItems(){
    var chickpop= document.getElementById('chickpop');
    ...
    const chickpopData= foodItem.filter((item)=>item.category=='chickpop');
    const milkteaData= foodItem.filter((item)=>item.category=='milktea');
    const teaData= foodItem.filter((item)=>item.category=='tea');
    const offerData= foodItem.filter((item)=>item.category=='offer');
    chickpopData.map(item=>{
